...
@section('content')
    ...
    <div class="card card-style preload-img entered loaded" data-src="images/pictures/18w.jpg" data-card-height="130" data-ll-status="loaded" style="height: 130px; background-image: url();">
