            ...
            <div class="col-12 p-0">
                <div class="card res_table">
                    <div class="card-header">
                        ...
                        <a href="{{route('user.restaurant-food-brands.create')}}" class="{{session()->get('locale')=='fa'? 'float-left' : 'float-right'}} bg-primary rounded p-1 px-3 text-light">{{ __('text.add') }}</a>
                        <div class="float-right">
                            <button class="btn" onclick="generatePDF()"><i class="fas fa-file-pdf text-danger fs-4"></i></button>
                        </div>
                    </div>
                    <div id="example2">
                        ...
                        @foreach($categories as $cat)
                            <div class="row mb-0 py-2 text-center border-bottom">
                                ...
                                <div class="col-4">
                                    <a href="{{route('user.restaurant-food-brands.edit', $cat->id)}}" class="badge bg-primary ml-1" title="ویرایش"><i class="fa fa-edit"></i> </a>
            ...
            <div class="modal-dialog mt-5 pt-5">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        {{ Form::open(array('route' => array('user.restaurant-food-brands.destroy', $cat->id), 'method' => 'DELETE', 'files' => true)) }}
