                            ...
                            @if(count($items)>0)
                                @foreach($items as $item)
                                    <div class="card-body res_table_in border mx-2 my-1 rounded">
                                        ...
                                        <small >{{' توضیحات : '.$item->text}}</small>

                                        @foreach($sub_items->where('belongs_to_item', '=', $item->id) as $sub_item)
                                            <div class="card-body res_table_in border mx-1 mb-2 rounded">
                                                <span class="px-5">
                                                    وضعیت : 
                                                    @if($sub_item->reply>0)
                                                        <span class="reply_email_ok text-success">پاسخ داده شده</span>
                                                ...
                                                <h5 class="pt-1">{{' موضوع : '.$sub_item->subject}}</h5>
                                                <p class="p-0">{{' توضیحات : '.$sub_item->text}}</p>
                                            </div>
                                        @endforeach
